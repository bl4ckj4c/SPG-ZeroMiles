...
echo "git clone https://github.com/bl4ckj4c/polito-se2-21-P01-SPG --branch release-1"
git clone https://github.com/bl4ckj4c/polito-se2-21-P01-SPG --branch release-1
